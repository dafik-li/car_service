...
public class ParseCompany {
    public static Company staxParseCompany() {
        Company company = new Company();
        Department department = new Department();
        Employee employee = new Employee();
        Service service = new Service();
        Car car = new Car();
        File xmlFile = new File("src/main/resources/new_xml/new_company.xml");
        File xsdFile = new File("src/main/resources/new_xml/new_company.xsd");
