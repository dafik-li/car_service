...
public class ActionController {
    ...
    public void authorization() {
        ...
        switch (menu) {
            case "1":
                userController.clientFormBuilder();
                break;
            case "2":
                adminController.moderateTables();
                break;
            case "0":
                System.exit(0);
                break;
...
/*
    ...
    public void retrieveByIdCompany() {
        ...
        LOGGER.info(
                ...
                "Company name - " + "" + companyOptional.get().getName() + "|" +
                "Company address - " + "" + companyOptional.get().getAddress());
    }
    public void removeByIdCompany() {
        LOGGER.info("Following company wil be delete");
        CompanyService companyService = new CompanyServiceImpl();
    ...
    public void removeByIdDepartment() {
        LOGGER.info("Following department wil be redundant");
        DepartmentService departmentService = new DepartmentServiceImpl();
    ...
    public void removeByIdEmployee() {
        LOGGER.info("Following employee wil be fired");
        EmployeeService employeeService = new EmployeeServiceImpl();
    ...
    public void addCar() {
        ...
        carService.add(car);
        LOGGER.info("Car - " + car.getBrand() + car.getModel() + car.getYear() + " - was adding");
    }
    ...
    public void removeByIdCar() {
        LOGGER.info("Following car wil be deleted");
        CarService carService = new CarServiceImpl();
    ...
    public void removeByIdOrder() {
        LOGGER.info("Following order wil be deleted");
        OrderService orderService = new OrderServiceImpl();
    ...
    public void addClient() {
        ...
        LOGGER.info("Client - " + client.getName() + client.getSurname() + " - was adding");
    }
    ...
    public void retrieveByIdClient() {
        ...
        LOGGER.info("Client id - " + "" + clientOptional.get().getId() + "|" +
    ...
    public void removeByIdClient() {
        LOGGER.info("Following car wil be delete");
        ClientService clientService = new ClientServiceImpl();
